...
public class ReminderService extends WakeReminderIntentService {
    ...
    void doReminderWork(Intent intent) {
        ...
        Intent notificationIntent = new Intent(this, AddNoteActivity.class);
        ...
        builder.setTicker("У Вас активная заметка!");
        ...
        if(Integer.parseInt(sound) == 0) builder.setSound(defaultSoundUri);
        builder.build();
